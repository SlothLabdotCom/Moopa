...
export default function HistoryOptions({ remove, watchId, aniId }) {
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className="group/delete w-6 h-6 shrink-0 bg-primary p-1 rounded-full hover:text-[#BA66DB] scale-100 hover:scale-105 transition-all duration-200 ease-out">
          <XMarkIcon />
