...
export default function Schedule({ schedule }: any) {
  ...
  return (
    <>
      <Head>
        <title>AnimeAbyss - Schedule</title>
        ...
        <meta
          name="keywords"
          content="anime, manga, AnimeAbyss, anilist, information, schedule, airing, next, currently, airing, anime, manga"
        />
        ...
        {/* <meta name="twitter:site" content="@AnimeAbyss_anime" />
        ...
        <meta
          ...
          content="AnimeAbyss is a website where you can find all the information about your favorite anime and manga."
        />
        <meta name="twitter:title" content="AnimeAbyss - Schedule" />
        <meta
