...
export default function About() {
  return (
    <>
      <Head>
        <title>AnimeAbyss - About</title>
        <meta name="title" content="About" />
        <meta
          name="description"
          content="AnimeAbyss is a platform where you can watch and stream anime or read
      ...
      >
        <div className="max-w-screen-lg w-full px-4 py-10">
          ...
          <p className="text-lg mb-8">
            AnimeAbyss is a platform where you can watch and stream anime or read
