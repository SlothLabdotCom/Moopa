...
const Terms = () => {
  return (
    <>
      ...
      <div style={{ color: 'white', padding: '9rem 12rem' }}>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-semibold mb-4 mt-4 text-white" style={{ fontSize: 30, paddingTop: 10 }}>
            1. Terms
          </h2>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-semibold mb-4 mt-4 text-white" style={{ fontSize: 30, paddingTop: 15 }}>
            2. Use License
          </h2>
          <p className="mb-4 text-sm" style={{ fontSize: 15, lineHeight: 1.5, paddingTop: 5 }}>
